...
# estimator = GradientBoostingClassifier(n_estimators=50, learning_rate=0.1, min_samples_leaf=50,max_features='sqrt',subsample=0.8,random_state=10)
...
# estimator = GradientBoostingClassifier(n_estimators=50, learning_rate=0.1,max_depth=5,max_features='sqrt',subsample=0.8,random_state=10)
...
estimator2 = GradientBoostingClassifier(n_estimators=50, learning_rate=0.1, min_samples_split=1, max_depth=5,min_samples_leaf=50, max_features='sqrt',subsample=0.8, random_state=10)
estimator3 = GradientBoostingClassifier(n_estimators=120, learning_rate=0.1, min_samples_split=1, max_depth=10,min_samples_leaf=60, max_features='sqrt',subsample=0.9, random_state=10)



# estimator = EnsembleClassifier(clfs=[estimator1, estimator2, estimator3], weights=[1,1,1])
estimator = EnsembleClassifier(clfs=[estimator1, estimator2, estimator3])

estimator.fit(df_train[predictors], df_train[targetname])
df_test['target'] = estimator.predict(df_test[predictors])


for clf, label in zip([estimator1, estimator2, estimator3, estimator], ['es1', 'es2', 'es3', 'Ensemble']):
